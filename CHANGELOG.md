...
FEATURES:
* **New List Resource**: `azurerm_cdn_frontdoor_origin_group` [GH-628]
...
FEATURES:
* **New List Resource**: `dedicated_host_group` [GH-612]
...
FEATURES:
* **New List Resource**: `azurerm_monitor_scheduled_query_rules_alert`  [GH-526]
...
BUG FIXES:
`azurerm_machine_learning_datastore_fileshare` - fix 5.0 migration bug for the `storage_fileshare_id` property [GH-525]
...
ENHANCEMENTS:
* dependencies: update `go-azure-sdk` to `v0.20260603.1074745` [GH-481]
